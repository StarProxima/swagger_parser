...
String _defaultValue(UniversalType t) => t.defaultValue != null
    ? ' = '
        '${t.enumType != null ? '${t.type}.${protectDefaultEnum(t.defaultValue?.toScreamingSnake)?.toScreamingSnake}' : protectDefaultValue(t.defaultValue, type: t.type, format: t.format, dart: false)}'
    : '';
